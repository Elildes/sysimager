...
projeto em um repositório.
    O Git Hub foi de grande importância porque mantinha o projeto sempres atualizado com a versão
mais recente, pois quando o trabalho era feito em sala de aula bastava baixar as atualizações
do projeto que estavam no repositório.
    O  (url) do projeto está no seguinte repositório:
    https://github.com/Elildes/ufrn-2019.1-itp-projeto.git
